ERC-20 token (a.k.a POI token) ICO Sale website deployed on the Goerli Ethereum Test Network with a simple, clean frontend. Built with Solidity, Truffle and Infura. 
